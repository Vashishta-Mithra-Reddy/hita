...
export default function HitaDesc() {
    return(
        <section className="relative py-40 md:py-44 md:pb-20 flex items-center justify-center px-12 md:mx-0 mx-4">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <motion.p initial={{opacity:0,y:50,filter:"blur(5px)"}} whileInView={{opacity:1,y:0,filter:"blur(0px)"}} transition={{ease:"easeIn",duration:0.5, delay: 0.4}} viewport={{once:true,amount:0.5}} className="text-lg md:text-xl text-foreground/80 leading-relaxed text-balance max-w-xl">
