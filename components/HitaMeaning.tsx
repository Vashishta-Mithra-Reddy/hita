export default function HitaMeaning(){
    return(
        <section className="flex flex-col items-center justify-center pt-16 px-6 max-w-3xl text-center -rotate-2 transition-all duration-500 opacity-60 pointer-events-none md:mx-0 mx-4">
