        ...
        <div className="rounded-2xl transition-all duration-300 p-6 w-full border-2 border-foreground/20 border-dashed hover:border-foreground/40 hover:-translate-y-0.5">
          ...
          <div className="space-y-3">
            <div className="flex flex-col items-start justify-start gap-4">
              <div className="relative overflow-hidden rounded-xl bg-foreground/5 aspect-square w-full h-[240px] flex-shrink-0">
                <img
              ...
              <div className="flex flex-col items-start justify-start text-left flex-1 min-w-0">
                ...
                <p className="text-foreground/60 text-sm leading-relaxed line-clamp-1 w-full mb-2">
                  {recipe.short_description || recipe.description}
                </p>
                
                {/* Recipe Meta Info */}
                <div className="flex flex-wrap gap-4 mt-1 mb-2 text-sm text-foreground/60">
                  {totalTime > 0 && (
