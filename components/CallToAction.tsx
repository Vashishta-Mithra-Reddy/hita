...
export default function CallToAction(){
    return(
        <section className="max-w-7xl relative py-40 md:pt-32 md:pb-60 flex items-center justify-center p-8 w-full rounded-xl">
          <div className="max-w-4xl mx-auto text-center">
            <motion.h2 initial={{opacity:0,y:50}} whileInView={{opacity:1,y:0}} transition={{duration:0.7}} viewport={{once:true,amount:0.5}} className="text-4xl md:text-6xl text-foreground/90 font-satoshi font-black mb-4">
              Start Your Journey
            </motion.h2>
