    ...
    return(
        <section className="max-w-7xl relative py-40 md:py-60 flex items-center justify-center p-8 w-full rounded-xl">
          <div className="max-w-4xl mx-auto text-center">
            <motion.h2 initial={{opacity:0,y:50}} whileInView={{opacity:1,y:0}} transition={{duration:0.7}} viewport={{once:true,amount:0.5}} className="text-4xl md:text-6xl text-foreground/90 font-satoshi font-bold mb-4">
              Start Your Journey
            </motion.h2>
            <motion.p initial={{opacity:0,y:50}} whileInView={{opacity:1,y:0}} transition={{duration:0.7, delay: 0.2}} viewport={{once:true,amount:0.5}} className="text-xl text-foreground/80 mb-6">
              Ready to transform your well-being? 
            </motion.p>
            <motion.div initial={{opacity:0,y:50}} whileInView={{opacity:1,y:0}} transition={{duration:0.7, delay: 0.4}} viewport={{once:true,amount:0.5}} className="flex flex-col md:flex-row gap-4 justify-center">
